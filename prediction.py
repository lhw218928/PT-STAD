...
class Predictor:
    ...
    def __init__(self, model, window_size, window_num, n_features, pred_args, summary_file_name="summary.txt"):
        self.model = model
    ...
    def get_score(self, values):
        ...
        data = SlidingWindowDataset(values, self.window_size,self.window_num, self.target_dims)
        ...
        recons = recons.reshape(-1,recons.shape[-1])
